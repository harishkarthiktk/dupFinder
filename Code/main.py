...
from hash_calculator import calculate_directory_hashes, calculate_file_hash, get_file_size
...
def main():
    ...
    parser.add_argument(
        "-d", "--database", default="file_hashes.db", help="SQLite database file path"
    )
    parser.add_argument(
        "-r", "--report", default="hash_report.html", help="Output HTML report file path"
    )
