...
An AI agent (e.g., in Code mode) should execute tasks sequentially, updating this `tasks.md` by marking checkboxes `[x]` upon completion and noting any issues in a sub-bullet.

## Task Checklist

- [x] **Task 1: Update Dependencies for PostgreSQL Support**
...
- [x] **Task 2: Create config.json and Configure Database Connection for PostgreSQL**
...
- [x] **Task 4: Refactor Database Functions to Use ORM**
...
- [x] **Task 5: Update Main Scripts to Use Refactored Database**
...
- [x] **Task 6: Documentation and Cleanup**
